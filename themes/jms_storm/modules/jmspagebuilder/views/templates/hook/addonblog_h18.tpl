	...
	{foreach from=$posts item=post}				
		...
		<div class="blog-item">
			...
			<div class="post-info">
				...
				{/if}
				{if $show_readmore == '1'}	
					<a class="post-readmore btn-hover" href="{jmsblog::getPageLink('jmsblog-post', $params)|escape:'htmlall':'UTF-8'|replace:'&amp;':'&'}">
					{l s='Read more' d='Modules.JmsPagebuilder'} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
				</a>	
				{/if}
			</div>
		</div>		
