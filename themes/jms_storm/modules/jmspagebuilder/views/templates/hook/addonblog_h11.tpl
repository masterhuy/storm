	...
	{foreach from=$posts item=post}				
		...
		<div class="blog-item">
				...
				{if $show_category == '1'}
					<div class="category-name"> 
						<a href="{jmsblog::getPageLink('jmsblog-category', $catparams)|escape:'htmlall':'UTF-8'|replace:'&amp;':'&'}">
							<i class="fa fa-thumb-tack" aria-hidden="true"></i> {$post.category_name|escape:'html':'UTF-8'}
						</a>
					</div>
				{/if}
			</div>
			...
			<div class="post-info">
				...
				<div class="readmore">
					{if $show_readmore == '1'}	
						<a class="btn-readmore" href="{jmsblog::getPageLink('jmsblog-post', $params)|escape:'htmlall':'UTF-8'|replace:'&amp;':'&'}">{l s='Read more' d='Modules.JmsPagebuilder'}</a>	
					{/if}
					{if $show_ncomments == '1'}		
						<div class="comment">
							<span>
