	            	...
	            	{foreach from=$category item=c_item }
						...
						<div class="categories-wrapper">
							...
							<div class="c_item-info">
								...
								<span class="count">
									{if $c_item.product_count > 0}
										({$c_item.product_count|escape:'html':'UTF-8'} {l s='items' d='Modules.JmsPagebuilder'})
									{else}
										({$c_item.product_count|escape:'html':'UTF-8'} {l s='item' d='Modules.JmsPagebuilder'})
									{/if}
								</span>
