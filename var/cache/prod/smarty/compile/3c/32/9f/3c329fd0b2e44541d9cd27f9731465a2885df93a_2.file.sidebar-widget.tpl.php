<?php
/* Smarty version 3.1.32, created on 2018-11-01 04:59:22
  from 'D:\xamppp\htdocs\jms_storm\modules\jmsblogwidget\views\templates\hook\sidebar-widget.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5bdac06a0faaa3_85538773',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3c329fd0b2e44541d9cd27f9731465a2885df93a' => 
    array (
      0 => 'D:\\xamppp\\htdocs\\jms_storm\\modules\\jmsblogwidget\\views\\templates\\hook\\sidebar-widget.tpl',
      1 => 1537260447,
      2 => 'file',
    ),
  ),
...
function content_5bdac06a0faaa3_85538773 (Smarty_Internal_Template $_smarty_tpl) {
...
?><aside class="blog-widget widget-tabs">	
	<div role="tabpanel" class="jms-tab">		  
		 <ul class="nav nav-tabs">			
			...
			<li class="nav-item active"><a href="#popularpost" aria-controls="popularpost" data-toggle="tab"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Popular','d'=>'Modules.JmsBlogwidget'),$_smarty_tpl ) );?>
</a></li>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['widget_setting']->value['JBW_SB_SHOW_RECENT']) {?>
			<li class="nav-item <?php if (!$_smarty_tpl->tpl_vars['widget_setting']->value['JBW_SB_SHOW_POPULAR']) {?>active<?php }?>"><a href="#latestpost" aria-controls="latestpost" data-toggle="tab"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Recent','d'=>'Modules.JmsBlogwidget'),$_smarty_tpl ) );?>
</a></li>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['widget_setting']->value['JBW_SB_SHOW_LATESTCOMMENT']) {?>
			<li class="nav-item <?php if (!$_smarty_tpl->tpl_vars['widget_setting']->value['JBW_SB_SHOW_POPULAR'] && !$_smarty_tpl->tpl_vars['widget_setting']->value['JBW_SB_SHOW_RECENT']) {?> active<?php }?>"><a href="#latestcomment" aria-controls="latestpost" data-toggle="tab"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Comments','d'=>'Modules.JmsBlogwidget'),$_smarty_tpl ) );?>
</a></li>
			<?php }?>
		  </ul>
...
<?php }
if ($_smarty_tpl->tpl_vars['widget_setting']->value['JBW_SB_SHOW_ARCHIVES']) {?>
